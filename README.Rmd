...
-  `which_stoplist` quoted argument specifying stopword list to apply, options include `none`, `MIT_stops`, `SMART`, `CA_OriginalStops`, or `Temple_stops25`. Default is `Temple_stops25`.
```{r, eval=F, message=F, warning=F}
