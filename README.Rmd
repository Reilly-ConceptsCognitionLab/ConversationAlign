...
![2 women having a conversation](man/figures/agepos1.jpg)
...
### read_dyads()
This function will read all your files and concatenate them into a single dataframe, appending document IDs
```{r, eval=F}
